...
import com.example.survey_jetpackcompose.util.Email
import com.example.survey_jetpackcompose.util.EmailState
import com.example.survey_jetpackcompose.util.EmailStateSaver
import com.example.survey_jetpackcompose.util.supportWideScreen
...
private fun Logo(
    ...
    val assetId = if (lightTheme) {
        R.drawable.my_survey_logo_login
    } else {
        R.drawable.my_survey_logo_login
    }
    Image(
